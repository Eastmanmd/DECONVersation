...
def main(args):
    ...
    adata = adata[adata.obs["newtype"].isin(["EpithelialGL_harmonal", "Endothelial", "Stromal_EMT", "EpithelialPino"])]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_cells_per_pseudobulk", type=int, default=70)
