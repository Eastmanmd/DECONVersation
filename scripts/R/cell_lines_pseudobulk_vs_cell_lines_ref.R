...
# Load bulk counts.
# genes_counts <- read.csv("/gpfs/commons/groups/compbio/projects/ao_projects/ml_deconv_data/cell_lines/test/pseudobulk_counts.csv", header = T, check.names = F, 
#                          row.names = 1)
genes_counts <- read.csv("/gpfs/commons/groups/compbio/projects/rf_projects/deconv_data/GSE220608/GSE220605_DataMatrix_Mixture_CellLines_Bulk_RNA-seq_gene_ids.csv",
...
singlespinal.sce  <- readRDS("/gpfs/commons/groups/compbio/projects/rf_projects/deconv_data/GSE220608/GSM6807287_cleanso.rds")
...
#singlespinal.sce <- subset(singlespinal.sce, subset = orig.ident %in% c("GSM6807287_M1", "GSM6807288_M2", "GSM6807289_M3", "GSM6807290_M4"))
...
#write.csv(results[["Est.prop.weighted"]],file="/gpfs/commons/groups/compbio/projects/ao_projects/ml_deconv/outputs/music_prop_pseudobulk_cell_lines_vs_ref.csv")
write.csv(results[["Est.prop.weighted"]],file="/gpfs/commons/groups/compbio/projects/ao_projects/ml_deconv_data_cell_lines/metrics_bulk/MuSiC_output_test_predictions_full.csv")
